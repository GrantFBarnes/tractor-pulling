...
// Download excel from JSON
router.post("/api/pulling/excel/download", (request, response) => {
...
router.post("/api/predict/winning", (request, response) => {
  returnPromiseResponse(response, main.predictWinChance(request.body));
});
